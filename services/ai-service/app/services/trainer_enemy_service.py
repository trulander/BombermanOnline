...
STATS_ENEMY_INFERENCE_SIZE: int = 7
GRID_ENEMY_INFERENCE_CHANNELS: int = 4
ACTION_ENEMY_INFERENCE_COUNT: int = 5


class TrainingEnemyService:
    def __init__(
        self,
        ...
        logger.info("TrainingPlayerService initialized")
    ...
    def start_training(
        ...
        options: dict = {
            "seed": 0,
            "training_player": False #Player, False is Enemy
        }
        ...
        if count_cpu == 1:
            ...
            vec_env = DummyVecEnv(
                env_fns=[
                    lambda: BombermanEnv(
                        grid_shape=(GRID_ENEMY_INFERENCE_CHANNELS, settings.WINDOW_SIZE, settings.WINDOW_SIZE),
                        action_count=ACTION_ENEMY_INFERENCE_COUNT,
